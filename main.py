...
def attack(char_name: str, char_class: str) -> str:
    """Here you see information about attack"""
...
def defence(char_name: str, char_class: str) -> str:
    """Here you see information about defence"""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Here you see information about special"""
    if char_class == 'warrior':
    ...
    return (f'{char_name} не применил спецальноу умение')


def start_training(char_name: str, char_class: str) -> str:
    """Here you see information about start_training"""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Here you see information about choice_char_class"""
